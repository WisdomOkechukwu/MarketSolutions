...
<html lang="en">
    ...
    <body class="d-flex flex-column">
        <main class="flex-shrink-0">
            ...
            <section class="py-5">
                <div class="container px-5">
                    <h1 class="fw-bolder fs-5 mb-4">Create Products</h1>
                            ...
                            <div class="row gx-0">
                                <div class="col-lg-6 col-xl-5 py-lg-5">
                                    <div class="p-4 p-md-5">
                                        ...
                                        <p>Here You can add your products and we will post it on the global page for buyers to purchase</p>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-xl-7"><div class="bg-featured-blog" style="background-image: url('../vendor/delta/Products.png')"></div></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container px-5">
                    <div class="row gx-5 justify-content-center">
                            <div class="col-lg-8 col-xl-6">
                                ...
                                <?php if(isset($_SESSION['AddedItem']) && $_SESSION['AddedItem'] == "true"){
                                    $_SESSION['AddedItem'] = "";
                                    ?>
                                    <div class="d-flex align-items-center" style="padding-bottom: 10px;">
                                        <strong>Added Product(You can go back to your product page)</strong>
                                ...
                                <form action="../helper/helpers/ItemRequest.php" method="POST">
                                    ...
                                    <?php } ?>
                                    <input type="hidden" name="User_RandomString" value="<?php echo $_SESSION['Random_loggedin']; ?>">

                                        <input id="pricename" class="form-control" name="name" type="text" 
                                        value="<?php if(isset($_SESSION['old_itemName'])){echo $_SESSION['old_itemName'];}
                                        ...
                                        <input  id="textedAreas" class="form-control" name="description" value="other" type="hidden" placeholder="Enter your message here..." style="height: 10rem" required ></input>
                                    </div>
                                    ...
                                    <div class="form-floating mb-3">
                                        ...
                                        class="form-control"
                                        value="<?php if(isset($_SESSION['old_itemPrice'])){echo $_SESSION['old_itemPrice'];}
                                            $_SESSION['old_itemPrice'] = "";?>"
                                        name="price" type="text" placeholder="name@example.com" required />
                                    ...
                                    <div class="d-grid"><button class="btn btn-primary btn-lg" name="submit_product" id="submitButton" type="submit">Add Product</button></div>
                                 </form>
                            </div>
                    </div>
                </div>
